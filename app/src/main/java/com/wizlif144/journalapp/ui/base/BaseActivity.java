...
import com.wizlif144.journalapp.utils.NetworkUtils;

import dagger.android.AndroidInjection;

public abstract class BaseActivity<T extends ViewDataBinding, V extends BasePresenter> extends AppCompatActivity
...
//        mProgressDialog = showLoadingDialog(this);
    ...
    private void performDataBinding() {
        ...
        this.mViewModel = mViewModel == null ? getPresenter() : mViewModel;
